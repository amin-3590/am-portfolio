...
const HeaderTab = () => {
  return (
    <ul className="flex lg:flex-row flex-col gap-6 text-gray-300/90 lg:relative absolute top-[120%] text-center left-[50%] -translate-x-[50%] lg:text-md text-xl bg-cyan-400/30 backdrop-blur-lg lg:bg-stone-900 w-full py-4">
